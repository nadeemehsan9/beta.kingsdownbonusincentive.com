...
export default function RejectedClaims() {
  const TITLE = "Kings Down | Rejected Claims";
  ...
  const showRecords = async () => {
    ...
    if (startDate && endDate) {
      try {
        setLoading(true);
        const response = await UserService.getSearchWithDateRejectedClaims(
          selectedCol,
          insertedVal,
          startDate,
          endDate,
  ...
  const showInvRecords = async () => {
    ...
    if (startInvDate && endInvDate) {
      try {
        setLoading(true);
        const response = await UserService.searchRejectedInvoiceDate(
          startInvDate,
          endInvDate,
          limit
        );
      ...
      if (id) {
        try {
          if (
            ...
            const response = await UserService.getAllRejectedClaims(newLimit);
            let resultData;
            ...
            if (
              ...
              const response =
                await UserService.getSearchWithDateRejectedClaims(
                  dateRef.current.value,
                  endDateRef.current.value,
                  newLimit
                );
            ...
            if (
              ...
              const response = await UserService.getSearchAllRejectedClaims(
                "",
                dateRef.current.value,
                newLimit,
                1
            ...
            if (
              ...
              const response =
                await UserService.getSearchWithoutDateRejectedClaims(
                  values.fieldtype,
                  values.searchval,
                  newLimit
                );
      ...
      if (id) {
        try {
          ...
          if (
            ...
            // admin
            const response = await UserService.getPaginatedRejectedClaims(
              pageNo,
              limit
            );
            ...
            //   endDateRef.current.value !== ""
            // ) {
            const response = await UserService.getPaginatedRejectedDateClaims(
              dateRef.current.value,
              endDateRef.current.value,
              pageNo,
              limit
            ...
            // ) {
            const response =
              await UserService.getPaginatedRejectedInvDateClaims(
                dateInvRef.current.value,
                endDateInvRef.current.value,
                pageNo,
                limit
            ...
            if (
              ...
              const response =
                await UserService.getSearchWithInvDateRejectedClaims(
                  "",
                  dateInvRef.current.value,
                  endDateInvRef.current.value,
                  limit,
  ...
  const getAllClaimsData = async () => {
    ...
    if (id) {
      try {
        ...
        const response = await UserService.rejectedClaimsList();
        console.log(response);
        let resultData;
        // if (response.status === 206) {
        resultData = response.data.response;
        ...
        <div className="wrapper">
          ...
          <main className="page-content">
            <div className="manage-heading-2">
              <h2>
                Rejected Claims <span>[{totalResults}]</span>
              </h2>
            </div>
                      ...
                      >
                        ...
                        <div className="col-lg-3">
                          <a
                            ...
                            style={styles.range}
                            href={`${API_URL}export-range-claims-clm/normal/rejected/${startDate}/${endDate}`}
                          >
                            Export by range
                          </a>
                        </div>
                        ...
                        <div className="col-lg-3">
                          <a
                            ...
                            href={`${API_URL}export-range-invoice-claims-clm/normal/rejected/${startInvDate}/${endInvDate}`}
                          >
                            Export by range
                          </a>
                        </div>
                      ...
                      <div className="col-lg-12 dropList mt-md-1">
                        <li className="dropdown1">
                          ...
                          <ul className="dropdown-menu">
                            <li>
                              <a
                                href={`${process.env.REACT_APP_API_Link}export-all-claims-clm/rejected?time=${time}`}
