...
export default function ViewRSAs() {
  ...
  const changeSelection = () => {
    ...
    $(".export-selection").attr(
      "href",
      `https://beta.api.selectyourrebate.com/v1/export-selected-rsa/${selectedRecords}?time=${time}`
    );
  ...
  const allSelect = async () => {
    ...
    $(".export-selection").attr(
      "href",
      `https://beta.api.selectyourrebate.com/v1/export-selected-rsa/${allSelections}?time=${time}`
    );
  };
