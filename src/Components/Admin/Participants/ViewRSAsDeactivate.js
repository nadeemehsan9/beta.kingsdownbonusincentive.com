...
export default function ViewRSAsDeactivate() {
  ...
  const changeSelection = () => {
    ...
    $(".export-selection").attr(
      "href",
      `https://beta.api.selectyourrebate.com/v1/export-selected-deactive-rsa/${selectedRecords}?time=${time}`
    );
  ...
  const allSelect = async () => {
    ...
    $(".export-selection").attr(
      "href",
      `https://beta.api.selectyourrebate.com/v1/export-selected-deactive-rsa/${allSelections}?time=${time}`
    );
  };
